            ...
            (function() {
                ...
                function A(e, t, n) {
                    return function(r, i, s) {
                        var o = 0,
                            u = x(r);
                        if (typeof s == "number") e > 0 ? o = s >= 0 ? s : Math.max(s + u, o) : u = s >= 0 ? Math.min(s + 1, u) : s + u + 1;
                ...
                m.flatten = function(e, t) {
                    ...
                    for (var r = 0, i = x(e); r < i; r++) {
                        ...
                        for (var o = 1; o < n; o++)
                            if (!m.contains(arguments[o], s)) break;
                        o === n && t.push(s)
                    }
                    return t
                ...
                }, m.noop = function() {}, m.property = E, m.propertyOf = function(e) {
            ...
            var r = e("underscore"),
                ...
                h = function() {
                    ...
                    function Pt() {
                        ...
                        r.identifier && !i && Q().id === ":" && (Y(), Y(":"), N = Object.create(n), J(r.value, {
                            type: "label"
                        }), !f.tokens.next.labelled && f.tokens.next.value !== "{" && z("W028", f.tokens.next, r.value, f.tokens.next.value), f.tokens.next.label = r.value, r = f.tokens.next);
                        if (r.id === "{") {
                    ...
                    function jt(e, t, n, i, s) {
                        ...
                        if (f.tokens.next.id === "{") {
                            ...
                            } else X("E021", f.tokens.next, "{", f.tokens.next.value);
                        else f.funct["(noblockscopedvar)"] = !0, (!t || f.option.curly) && z("W116", f.tokens.next, "{", f.tokens.next.value), f.tokens.next.inBracelessBlock = !0, b += f.option.indent, o = [Pt()], b -= f.option.indent, delete f.funct["(noblockscopedvar)"];
                        switch (f.funct["(verb)"]) {
                            case "break":
                            case "continue":
                            case "return":
                    ...
                    function It(e) {
                        var t = e.value,
                            n = Object.getOwnPropertyDescriptor(g, t);
                    ...
                    function Vt(e) {
                        var t, n = [],
                            ...
                            a = !1,
                            l = e && e.loneArg;
                        if (l && l.identifier === !0) return J(l.value, {
                            type: "unused",
                            token: l
                        }), [l.value];
                        ...
                        for (;;) {
                            if (r.contains(["{", "["], f.tokens.next.id)) {
                                s = nn();
                                for (o in s) o = s[o], o.id && (n.push(o.id), J(o.id, {
                                    type: "unused",
                                    token: o.token
                                }))
                            } else {
                    ...
                    function Qt(e) {
                        ...
                        var t = this.context,
                            ...
                            r = this.depth;
                        if (!n)
                            while (!i()) !f.tokens.next.template || f.tokens.next.depth > r ? nt(0) : Y();
                        return {
                            id: "(template)",
                            type: "(template)",
                            tag: e
                    ...
                    function tn(e) {
                        if (f.inES5())
                            for (var t in e) r.has(e, t) && e[t].setterToken && !e[t].getterToken && z("W078", e[t].setterToken)
                    }
                    ...
                    function nn() {
                        ...
                        var r = function() {
                            ...
                            } else if (mn(f.tokens.next, [","])) n.push({
                                id: null,
                                token: f.tokens.curr
                            });
                            else {
                        ...
                        if (mn(f.tokens.next, ["["])) {
                            ...
                            while (!mn(f.tokens.next, ["}"])) {
                                Y(",");
                                if (mn(f.tokens.next, ["}"])) break;
                                e = Mt(), mn(f.tokens.next, [":"]) ? (Y(":"), r()) : n.push({
                                    id: e,
                                    token: f.tokens.curr
                                })
                            }
                    ...
                    function dn(e, t, n, i, s, o) {
                        var u = e === "get" ? "getterToken" : "setterToken",
                            a = "";
                    ...
                    function bn() {
                        function e() {
                            ...
                            if (f.tokens.next.id !== "}")
                                for (;;) {
                                    if (f.tokens.next.id === "(end)") X("E026", f.tokens.next, t.line);
                                    else {
                                        if (f.tokens.next.id === "}") {
                        ...
                        function t() {
                            ...
                            if (f.tokens.next.id !== "]")
                                for (;;) {
                                    if (f.tokens.next.id === "(end)") X("E027", f.tokens.next, e.line);
                                    else {
                                        if (f.tokens.next.id === "]") {
                                            z("W094", f.tokens.curr);
                                            break
                    ...
                    var e, t = {
                        ...
                        n, p, d = ["closure", "exception", "global", "label", "outer", "unused", "var"],
                        v, m, g, y, b, w, E, S, x, T, N, C, k, L, A = [],
                    ...
                    St.legacy = ["xml", "unknown"], St.es3 = ["undefined", "boolean", "number", "string", "function", "object"], St.es3 = St.es3.concat(St.legacy), St.es6 = St.es3.concat("symbol"), dt("(number)", function() {
                        ...
                        nud: function() {
                            ...
                            r = f.funct["(blockscope)"].getlabel(e), typeof t == "function" ? t = undefined : !r && typeof t == "boolean" && (n = f.funct, f.funct = v[0], J(e, {
                                type: "var"
                            }), t = f.funct, f.funct = n);
                            if (f.funct === t || r) switch (r ? r[e]["(type)"] : f.funct[e]) {
                                ...
                                default:
                                    if (t === !0) f.funct[e] = !0;
                                    else if (t === null) z("W039", f.tokens.curr, e), It(f.tokens.curr);
                                    else if (typeof t != "object") f.funct["(comparray)"].check(e) || R(f.funct, "W117", f.tokens.curr, e), f.funct["(global)"] || (f.funct[e] = !0), It(f.tokens.curr);
                                    else switch (t[e]) {
                                        case "function":
                                        case "unction":
                    ...
                    yt("||", function(e, t) {
                            ...
                            if (e && e.id !== "function")
                                ...
                                } else e.id !== "." && e.id !== "[" && e.id !== "(" && z("W056", f.tokens.curr);
                            else f.option.supernew || z("W057", this);
                        ...
                        function(e) {
                            e.nud = function() {
                                ...
                                for (;;) {
                                    ...
                                    if (!f.tokens.next.identifier || G().id !== "," && G().id !== "}")
                                        if (Q().id === ":" || o !== "get" && o !== "set") {
                                            ...
                                            f.tokens.next.value === "(" ? (f.inESNext() || z("W104", f.tokens.curr, "concise methods"), Gt({
                                                type: s ? "generator" : null
                                            })) : (Y(":"), nt(10))
                                        } else Y(o), f.inES5() || X("E034"), n = Xt(), !n && !f.inESNext() && X("E035"), n && dn(o, u, n, f.tokens.curr), i = f.tokens.next, t = Gt(), r = t["(params)"], o === "get" && n && r ? z("W076", i, r[0], n) : o === "set" && n && (!r || r.length !== 1) && z("W077", i, n);
                                    else f.inESNext() || z("W104", f.tokens.next, "object short notation"), n = Xt(!0), pn(u, n, f.tokens.next), nt(10);
                                    Ft(n);
                                    if (f.tokens.next.id !== ",") break;
                                    ut({
                                        allowTrailing: !0,
                    ...
                    an.exps = !0, ct("class", function() {
                            ...
                            var e = !1;
                            f.tokens.next.value === "*" && (Y("*"), f.inESNext({
                                strict: !0
                            }) ? e = !0 : z("W119", f.tokens.curr, "function*")), y && z("W082", f.tokens.curr);
                            var t = Ot();
                            ...
                            function t() {
                                ...
                                Y("catch"), Y("("), N = Object.create(e), t = f.tokens.next.value, f.tokens.next.type !== "(identifier)" && (t = null, z("E030", f.tokens.next, t)), Y(), f.funct = $t("(catch)", f.tokens.next, N, {
                                    ...
                                    type: "exception"
                                }), f.tokens.next.value === "if" && (f.inMoz() || z("W118", f.tokens.curr, "catch filter"), Y("if"), nt(0)), Y(")"), f.tokens.curr.funct = f.funct, v.push(f.funct), jt(!1), N = e, f.funct["(last)"] = f.tokens.curr.line, f.funct["(lastcharacter)"] = f.tokens.curr.character, f.funct = f.funct["(context)"]
                            }
                            var e;
                            jt(!0);
                        ...
                        function() {
                            ...
                            if (r.contains(u, s.value)) {
                                ...
                                var h = !c && !l;
                                c && X("W133", l, s.value, "initializer is forbidden"), l && X("W133", l, s.value, "more than one ForBinding"), f.tokens.next.id === "var" ? (Y("var"), f.tokens.curr.fud({
                                    prefix: !0
                                })) : f.tokens.next.id === "let" || f.tokens.next.id === "const" ? (Y(f.tokens.next.id), n = !0, f.funct["(blockscope)"].stack(), f.tokens.curr.fud({
                                    prefix: !0
                                })) : Object.create(an).fud({
                                    prefix: !0,
                                    implied: "for",
                                    ignore: !h
                                }), Y(s.value), nt(20), Y(")", t), s.value === "in" && f.option.forin && (f.forinifcheckneeded = !0, f.forinifchecks === undefined && (f.forinifchecks = []), f.forinifchecks.push({
                                    type: "(none)"
                                })), e = jt(!0, !0);
                                ...
                                i && X("E045", i);
                                if (f.tokens.next.id !== ";")
                                    if (f.tokens.next.id === "var") Y("var"), f.tokens.curr.fud();
                                    else if (f.tokens.next.id === "let") Y("let"), n = !0, f.funct["(blockscope)"].stack(), f.tokens.curr.fud();
                                else
                                    for (;;) {
                                        nt(0, "for");
                                        if (f.tokens.next.id !== ",") break;
                        ...
                        function(e) {
                            ...
                            return f.tokens.next.id === "var" ? (Y("var"), f.tokens.curr.fud({
                                inexport: !0
                            })) : f.tokens.next.id === "let" ? (Y("let"), f.tokens.curr.fud({
                                inexport: !0
                            })) : f.tokens.next.id === "const" ? (Y("const"), f.tokens.curr.fud({
                                inexport: !0
                            })) : f.tokens.next.id === "function" ? (this.block = !0, Y("function"), p[f.tokens.next.value] = e, f.tokens.next.exported = !0, f.syntax["function"].fud()) : f.tokens.next.id === "class" ? (this.block = !0, Y("class"), p[f.tokens.next.value] = e, f.tokens.next.exported = !0, f.syntax["class"].fud()) : X("E024", f.tokens.next, f.tokens.next.value), this
                            ...
                            es5: !0
                        }), mt("final"), mt("float"), mt("goto"), mt("implements", {
                            es5: !0,
                            strictOnly: !0
                        }), mt("import", {
                            es5: !0
                            ...
                            es5: !0
                        }), mt("synchronized"), mt("transient"), mt("volatile");
                    var hn = function() {
                            var e, t, n = -1,
                                r = 0,
                                i = {};
                        ...
                        xn = function(t, i, o) {
                            ...
                            if (i) {
                                ...
                                for (c = 0; c < H.length; c++)
                                    if (/^-W\d{3}$/g.test(H[c])) F[H[c].slice(1)] = !0;
                                    else {
                                        var U = H[c];
                            ...
                            try {
                                ...
                                v.forEach(function(e) {
                                    ...
                                    while (i) {
                                        ...
                                        if (s === "unused" || s === "unction") wn(i, e["(tokens)"][i], "param", e["(unusedOption)"]);
